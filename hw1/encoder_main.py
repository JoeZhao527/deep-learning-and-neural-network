...
# these are unploted epoches
# 5000,7000,10000,15000,20000,30000,50000,70000,100000,150000,200000,300000,500000,700000,1000000
...
while epoch < args.epochs and loss > args.stop:
    ...
    for batch_id, (data,target) in enumerate(train_loader):
        ...
        if args.plot and plot_epoch( epoch ):
            plt.clf()
            plot_hidden(net)
            plt.savefig('encoder_%s.png' % epoch)
            # plt.show()
